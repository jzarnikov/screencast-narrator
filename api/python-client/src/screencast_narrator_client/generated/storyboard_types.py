...
#   timestamp: 2026-03-26T19:45:26+00:00
...
class Options(BaseModel):
    ...
    voices: dict[str, Voices] | None = Field(
        None,
        description='Named voice identities mapping alias to gender (e.g. {"nathaly": "female", "james": "male"})',
    )
